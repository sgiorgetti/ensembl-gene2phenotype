...
my $mappings = {
  'original_allelic_requirement' => {
    'allelic_requirement' => {
      ...
      'digenic' => 'mitochondrial', # still a placeholder, will be completely deleted before migration
      'monoallelic' => 'monoallelic_autosomal',
      'monoallelic (Y)' => 'monoallelic_Y_hem',
      'mosaic' => 'monoallelic_autosomal',
      'uncertain' => 'mitochondrial', # still a placeholder, will be completely deleted before migration
