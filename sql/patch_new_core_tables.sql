...
CREATE TABLE IF NOT EXISTS allele_feature (
  ...
  hgvs_genomic varchar(255)  DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS LGM_panel_disease (
  ...
  default_name tinyint(1) unsigned NOT NULL DEFAULT '0',
  user_id int(10) unsigned NOT NULL,
  created timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE IF NOT EXISTS LGM_phenotype (
...
CREATE TABLE IF NOT EXISTS placeholder_feature (
